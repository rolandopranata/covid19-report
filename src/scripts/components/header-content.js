    ...
    <div class="container-fluid bg-hero">
        ...
        <div class="row align-items-center pt-5 pb-5">
            <div class="col-lg-7 col-sm-12 col-md-12">
              ...
              <p class="lh-7 description-text" data-aos="fade-left" data-aos-duration="2000">Virus Corona atau COVID-19 adalah sebuah virus yang berasal dari Kota Wuhan, China. Virus ini menyebar melalui udara dan dengan cepat menyebar ke hampir seluruh negara dan akhirnya menjadi pandemi seperti sekarang.</p>
